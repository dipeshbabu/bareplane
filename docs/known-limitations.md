...
- Initial GitOps supports anonymous HTTPS repositories and an exact reviewed payload. Private Git credentials, arbitrary plugins, and embedded secrets are unsupported.
